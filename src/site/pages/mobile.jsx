          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="bloco">
                ...
                <a href="https://drive.google.com/file/d/1OtlXaZlBkAAdw6mag8biYPIh4MyPp1iv/view?usp=sharing" type="button" className="btn btn-success btn-lg btn-app"><i className="fa fa-android"></i> Android<br/>DeliveryBairro UserApp v1.0 Build #1</a>
