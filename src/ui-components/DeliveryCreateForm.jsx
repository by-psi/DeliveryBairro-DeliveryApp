...
export default function DeliveryCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setTokenADM(initialValues.TokenADM);
    setErrors({});
  };
  const validations = {
    Nome: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Delivery(modelFields));
          if (onSuccess) {
